const API_INSTI = SERVER + 'dashboard/institucion.php?action=';
    ...
    dataset.map(function (row) {
        ...
        content += `
            <tr>
                ...
                <td>
                    <a onclick="openUpdate(${row.id_insti})" class="btn-floating blue tooltipped" data-tooltip="Actualizar">
                        <i class="material-icons">mode_edit</i>
                    </a>
                    <a onclick="openDelete(${row.id_insti})" class="btn-floating red tooltipped" data-tooltip="Eliminar">
                        <i class="material-icons">delete</i>
                    </a>
                    <a onclick="openReport(${row.id_insti})" class="btn-floating indigo tooltipped" data-tooltip="Reporte">
...
function openReport(id) {
    ...
    let url = SERVER + 'Reportes/instituciones.php';
