    ...
    const API_PROVEE = SERVER + 'dashboard/proveedor.php?action=';
...
function fillTable(dataset) {
        ...
        content += `
            <tr>
                ...
                <td>
                    ...
                    <a onclick="openDelete(${row.id_provee})" class="btn-floating red tooltipped" data-tooltip="Eliminar">
                        <i class="material-icons">delete</i>
                    </a>
                    <a onclick="openReport(${row.id_provee})" class="btn-floating indigo tooltipped" data-tooltip="Reporte">
    ...
    document.getElementById('dato').innerHTML = content;
...
function openReport(id) {
    ...
    let url = SERVER + 'Reportes/proveedor.php';
